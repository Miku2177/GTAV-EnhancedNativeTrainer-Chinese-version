...
namespace PLAYER
{
	...
	static int GET_PLAYER_FAKE_WANTED_LEVEL(Player player) { return invoke<Player>(0x56105E599CAB0EFA, player); } // 0x56105E599CAB0EFA
}
...
namespace PED
{
	...
	static BOOL _PED_SKIP_NEXT_RELOADING(Ped ped) { return invoke<BOOL>(0x8C0D57EA686FAD87); } // 0x8C0D57EA686FAD87 0x82EEAF0F
