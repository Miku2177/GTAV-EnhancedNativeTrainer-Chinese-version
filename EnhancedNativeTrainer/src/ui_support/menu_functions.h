...
{	
	// *Mainly setup for controller use
	...
	UI::HIDE_HUD_COMPONENT_THIS_FRAME(HudComponentVehicleClass);
	...
	CONTROLS::DISABLE_CONTROL_ACTION(2, INPUT_VEH_SELECT_NEXT_WEAPON, true);
