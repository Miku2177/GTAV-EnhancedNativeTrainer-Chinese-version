...
const std::vector<std::string> CAPTIONS_ATTACH_REVOLVERMK2{ "Default Clip", "Tracer Rounds", "Incendiary Rounds", "Armour Piercing Rounds", "Full-Metal Jacket Rounds", "Improved Sights", "Macro Scope", "Flash Hider", "Comp3", "Digital Camo", "Zebra Camo", "Green Camo", "Skull Camo", "Diamond Camo", "Designer Camo", "Zebra Camo 2", "White Tiger Camo", "Urban Camo", "Boom! Camo", "Independance Day Camo" };
