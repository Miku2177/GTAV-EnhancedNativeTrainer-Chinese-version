...
const std::vector<TireSmokeColor> SMOKE_COLORS = {
	...
	{ UI::_GET_LABEL_TEXT("CMOD_SMOKE_5"), TIRESMOKE_COLOR_BLUE },
	{ UI::_GET_LABEL_TEXT("CMOD_SMOKE_6"), TIRESMOKE_COLOR_YELLOW },
	{ UI::_GET_LABEL_TEXT("CMOD_SMOKE_11"), TIRESMOKE_COLOR_PURPLE },
	{ UI::_GET_LABEL_TEXT("CMOD_SMOKE_7"), TIRESMOKE_COLOR_ORANGE },
	{ UI::_GET_LABEL_TEXT("CMOD_SMOKE_10"), TIRESMOKE_COLOR_GREEN },
	{ UI::_GET_LABEL_TEXT("CMOD_SMOKE_8"), TIRESMOKE_COLOR_RED },
	{ UI::_GET_LABEL_TEXT("CMOD_SMOKE_12"), TIRESMOKE_COLOR_PINK },
