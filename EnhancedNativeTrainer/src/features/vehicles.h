...
const std::vector<VehicleImage> INGAME_VEH_IMAGES =
{
	...
	{ RAGE_JOAAT("AIRTUG"), "ENT_vehicle_previews", "AIRTUG" },
	...
	{ RAGE_JOAAT("ARMYTRAILER2"), "ENT_vehicle_previews", "ARMYTRAILER2" },
	{ RAGE_JOAAT("ASEA2"), "ENT_vehicle_previews", "VP_ASEA_SNOW" },
	{ RAGE_JOAAT("BAGGER"), "ENT_vehicle_previews", "BAGGER" },
	...
	{ RAGE_JOAAT("BULLDOZER"), "ENT_vehicle_previews", "VP_BULLDOZER" },
	...
	{ RAGE_JOAAT("TRAILERS2"), "ENT_vehicle_previews", "TRAILERS2" },
