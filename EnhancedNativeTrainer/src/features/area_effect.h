...
const std::vector<std::vector<std::string>> VOV_PED_WEAPONS{ {}, PED_WEAPONS_MELEE, PED_WEAPONS_SMALL, PED_WEAPONS_RIFLES, PED_WEAPONS_HEAVY, PED_WEAPONS_EXPLOSIVES, PED_WEAPONS_RANDOM, PED_WEAPONS_RANDOM_NO_SUPERDEADLY };

const std::vector<std::string> PED_WEAPON_TITLES{ "Custom Weapon", "Melee", "Small Arms", "Rifles", "Heavy", "Explosives", "Random (all weapons)", "Random (w/o instant kill weapons)" };
