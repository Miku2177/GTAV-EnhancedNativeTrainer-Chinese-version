...
// Train Speed
const std::vector<std::string> WORLD_TRAIN_SPEED_CAPTIONS{ "OFF", "0.0", "5.0", "30.0", "60.0", "100.0", "200.0", "300.0" };
const float WORLD_TRAIN_SPEED_VALUES[] = { -1.0, 0.0, 5.0, 30.0, 60.0, 100.0, 200.0, 300.0 };
