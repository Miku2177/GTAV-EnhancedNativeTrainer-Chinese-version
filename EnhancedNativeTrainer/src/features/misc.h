...
const std::vector<std::string> MISC_MUSICEVENT_VALUES{ "AH1_HOLE_RESTART", "AH2A_FIRST_FLOOR_RESTART", /*"AH3A_ABSEIL_RT",*/ "AH3A_FIB_DOCS_RT", "AH3A_RUBBLE_RT", "AH3B_BURNTOUT_RT", "AH3B_BURNTOUT_TWO_RT", "AH3B_DOWNLOADING_RT",
 "AH3B_EVADE_COPS_RT", "AH3B_GET_TO_VAN_RT", /*"AH3B_HACK_RT",*/ /*"AH3B_HELI_LIFT_OFF",*/ /*"AH3B_STAIRWELL",*/ /*"APT_SUDDEN_DEATH_START_MUSIC",*/ /*"ARM3_CS",*/ "ARM3_RESTART_4", "BG_SIGHTSEER_START_ATTACK", /*"BST_START",*/
 "CAR4_TRUCK_RESTART", /*"CHN1_AFTER_GRENADE_RT",*/ /*"DH1_START",*/ /*"DH2A_1ST_BOMB_RT",*/ /*"DH2A_WAY_OUT_RT",*/ "DH2B_DROP_SUB_RT", /*"DH2B_FLY_AWAY_RT",*/ "EPS6_START", "EXL2_SNIPE_RT", /*"EXL3_SWITCH_1",*/ "EXTREME1_BIKE",
 /*"EXTREME1_RESTART1",*/ /*"EXTREME2_RESTART2",*/ /*"FAM1_DO_CHASE_RT",*/ "FAM3_CHASE_RESTART", /*"FAM5_YOGA_MUSIC_RESTART",*/ "FBI1_OUTSIDE_CORONERS_RT", /*"FBI1_SHOOTOUT_HALFWAY_RT",*/ /*"FBI3_TORTURE_START",*/
 ...
 "FH2B_HELI_CHASE_RESTART", "FH2B_LEAVE_BANK", /*"FIN1_SO_2_RT",*/ "FINA_RESTART_CHASE", /*"FINB_RESTART_ARRIVE",*/ "FRA2_CUT_LAMAR_RT", "JH2A_EXIT_TUNNEL_RESTART", /*"JH2A_GAS_SHOP_RESTART",*/ "KILL_LIST_START_MUSIC", "LM1_TERMINADOR_ENTER_WAREHOUSE_RESTART",
 "MGPS_START", "MIC1_DRIVE_TO_GRAVEYARD", "MIC2_HANGING_RT", /*"MIC3_ESCAPE_RESTART",*/ "MP_DM_START_ALL", /*"OJDA5_START",*/ "PAP2_CAR_RESTART",
 /*"PENNED_IN_START_MUSIC",*/ "PROLOGUE_TEST_GETAWAY_RT", /*"PTP_START",*/ /*"RH1_START",*/ /*"RH2A_BANK_RESTART",*/ /*"SOL1_CHASE_PLANE_RT",*/ /*"SOL1_FIGHT_RT",*/ /*"SOL1_GET_SOL_RT",*/
 /*"SOL1_SHOOT_PLANE_RT",*/ "SOL2_RESTART1", /*"SOL5_FIGHT_BAD_RT",*/ /*"TRV1_CHASE_BIKERS_RT",*/ "TRV1_DRIVE_TRAILER_RT", /*"TRV2_RACE",*/ "TRV2_WING_RESTART" };
