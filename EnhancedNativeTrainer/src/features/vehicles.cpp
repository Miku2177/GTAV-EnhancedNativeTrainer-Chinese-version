...
const std::vector<std::string> VALUES_PLANES{ "BLIMP", "ALPHAZ1", "CARGOPLANE", "HOWARD", "JET", "LUXOR", "LUXOR2", "MILJET", "NIMBUS", "PYRO", "SHAMAL", "VESTRA", "MAMMATUS", "LAZER", "VELUM", "VELUM2", "STARLING", "AVENGER", "DODO", "HYDRA", "TITAN", "TULA", "MOGUL", "NOKOTA", "BOMBUSHKA", "MOLOTOK", "VOLATOL","BESRA", "ROGUE", "SEABREEZE", "CUBAN800", "DUSTER", "STUNT", "BLIMP2", };
...
void update_vehicle_features(BOOL bPlayerExists, Ped playerPed){
	...
	if ((version > 35) && (version < 39)) *getGlobalPtr(4265719) = 1;

	if (version > 38) *getGlobalPtr(4265719) = 1; //2606794
