...
const std::vector<std::string> VALUES_OFFROAD{ "HELLION", "BRUISER", "BRUISER2", "BRUISER3", "DUBSTA3", "BIFTA", "DUNE", "DUNE3", "BFINJECTION", "DUNE2", "DLOADER", "MONSTER3", "MONSTER4", "MONSTER5", "BODHI2", "FREECRAWLER", "KALAHARI", "KAMACHO", "MESA3", "MARSHALL", "BRAWLER", "BRUTUS", "BRUTUS2", "BRUTUS3", "RANCHERXL", "RANCHERXL2", "INSURGENT2", "INSURGENT", "INSURGENT3", "MENACER", "NIGHTSHARK", "EVERON", "REBEL2", "REBEL", "TECHNICAL", "TECHNICAL2", "TECHNICAL3", "BLAZER", "BLAZER3", "BLAZER2", "BLAZER5", "BLAZER4", "VAGRANT", "DUNE4", "DUNE5", "ZHABA", "OUTLAW", "RCBANDITO", "CARACARA", "CARACARA2", "TROPHYTRUCK2", "RIATA", "SANDKING2", "SANDKING", "TROPHYTRUCK", "MONSTER" };
...
const std::vector<std::string> VALUES_COMPACTS{ "PANTO", "PRAIRIE", "RHAPSODY", "BLISTA", "KANJO", "BRIOSO", "DILETTANTE", "DILETTANTE2", "ASBO", "FORMULA2", "FORMULA", "ISSI2", "ISSI3", "ISSI4", "ISSI5", "ISSI6" };
...
const std::vector<VehicleImage> INGAME_VEH_IMAGES =
{
  ...
  //{ "TECHNICAL3", "lgm_dlc_specialraces", "gp1" }, //no image yet
	...
	{ "FORMULA2", "lgm_dlc_casinoheist", "formula" },
