...
const std::vector<std::string> VALUES_SUPERCARS{ "LE7B", "BANSHEE2", "VOLTIC2", "VOLTIC", "VAGNER", "SHEAVA", "CHEETAH", "TURISMOR", "VISIONE", "PROTOTIPO", "SULTANRS", "PENETRATOR", "XA21", "ENTITYXF", "INFERNUS", "OSIRIS", "REAPER", "TEMPESTA", "VACCA", "ZENTORNO", "PFISTER811", "GP1", "ITALIGTB", "ITALIGTB2", "T20", "TYRUS", "ADDER", "NERO", "NERO2", "BULLET", "FMJ", "VIGILANTE" };
...
const std::vector<std::string> VALUES_SPORTCLASSICS{ "BTYPE2", "MANANA", "BTYPE", "BTYPE3", "FELTZER3", "MAMBA", "TORNADO", "TORNADO5", "TORNADO3", "TORNADO2", "TORNADO4", "TORNADO6", "JB700", "RAPIDGT3", "CHEETAH2", "STINGER", "STINGERGT", "TURISMO2", "COQUETTE2", "CASCO", "PIGALLE", "ARDENT", "INFERNUS2", "MONROE", "ZTYPE", "PEYOTE", "RETINUE" };
