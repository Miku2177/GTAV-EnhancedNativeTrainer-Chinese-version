...
void update_vehicle_features(BOOL bPlayerExists, Ped playerPed){
	...
	// Infinite Rocket Boost
	if (VEH_INFINITEBOOST_VALUES[InfiniteBoostIndex] > 0 && PED::IS_PED_IN_ANY_VEHICLE(playerPed, 0)) {
	...
	if (bPlayerExists && PED::IS_PED_IN_ANY_VEHICLE(playerPed, 1) && VEH_TURN_SIGNALS_VALUES[turnSignalsIndex] > 0 || featureHazards) {
		...
		if (VEH_TURN_SIGNALS_VALUES[turnSignalsIndex] > 0 || (featureHazards && turn_check_right == true && turn_check_left == true)) {
			if (turn_angle > VEH_TURN_SIGNALS_ANGLE_VALUES[turnSignalsAngleIndex] ||
				...
				(emergencyKey && VEH_TURN_SIGNALS_VALUES[turnSignalsIndex] > 0) ||
...
///////////////////////////////////////////// REMEMBER VEHICLES /////////////////////////////////////////////////////////////
	...
	if (GAMEPLAY::GET_MISSION_FLAG() == 0 && !SCRIPT::HAS_SCRIPT_LOADED("fbi4_prep3amb") && !SCRIPT::HAS_SCRIPT_LOADED("finale_heist_prepeamb")) {
...
///////////////////////////////////////////////////////////////////////////////////
	...
	if ((WORLD_REDUCEDGRIP_SNOWING_VALUES[RadarReducedGripSnowingIndex] > 0 && featureSnow) || WORLD_REDUCEDGRIP_SNOWING_VALUES[RadarReducedGripRainingIndex] > 0) {
