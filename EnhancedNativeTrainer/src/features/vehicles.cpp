...
const std::vector<std::string> CAPTIONS_COUPES{"Dewbauchee Exemplar", "Enus Cognoscenti Cabrio", "Enus Windsor", "Enus Windsor Drop (Executive)", "Lampadati Felon", "Lampadati Felon GT", "Ocelot F620", "Ocelot Jackal", "Ubermacht Sentinel", "Ubermacht Sentinel XS", "Ubermacht Zion", "Ubermacht Zion Cabrio"};
...
const std::vector<std::string> VALUES_SUPERCARS{"LE7B", "VOLTIC","VOLTIC2","SHEAVA", "CHEETAH", "TURISMOR", "TURISMO2", "PROTOTIPO", "ENTITYXF","PENETRATOR", "INFERNUS", "INFERNUS2", "OSIRIS", "REAPER", "TEMPESTA", "VACCA", "ZENTORNO", "PFISTER811", "ITALIGTB", "ITALIGTB2", "RUSTON", "T20", "TYRUS", "ADDER","NERO","NERO2", "BULLET", "FMJ"};
...
const std::vector<std::string> CAPTIONS_SERVICES{"Airtug", "Brute Airport Bus", "Brute Bus (City Bus)", "Brute Rental Shuttle Bus", "Brute Tourbus", "Cable Car (Mt. Chilliad)", "Dashound Coach", "Dozer", "Forklift", "Jobuilt Trashmaster", "Jobuilt Trashmaster (Rusty)", "Nagasaki Caddy (New)", "Nagasaki Caddy (Old)", "MTL Brickade (Executive)", "MTL Dune (Race)", "Ripley (Airport Tug)", "Stanley Fieldmaster Tractor", "Stanley Fieldmaster Tractor (Snow)", "Stanley Lawn Mower", "Stanley Tractor (Rusty)", "Vapid Pickup Utility", "Vapid Plumbing Utility", "Vapid Telephone Utility"};
...
const std::vector<std::string> VALUES_SERVICES{"AIRTUG", "AIRBUS", "BUS", "RENTALBUS", "TOURBUS", "CABLECAR", "COACH", "BULLDOZER", "FORKLIFT", "TRASH", "TRASH2", "CADDY", "CADDY2", "BRICKADE", "RALLYTRUCK", "RIPLEY", "TRACTOR2", "TRACTOR3", "MOWER", "TRACTOR", "UTILLITRUCK3", "UTILLITRUCK2", "UTILLITRUCK"};
