...
void update_teleport_features(){
	...
	if (featureHouseOnHill && ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()) && househill_init == false)
	{
		...
		if (househill_tick > 400) { // 1000
			...
			INTERIOR::_SET_INTERIOR_ENTITY_SET_COLOR(MansionTop, "m25_2_ch1_06e_mansion_interior_a", 100);
			INTERIOR::_SET_INTERIOR_ENTITY_SET_COLOR(Mansionlow, "m25_2_ch1_06e_mansion_interior_c", 100);
			INTERIOR::_SET_INTERIOR_ENTITY_SET_COLOR(Mansiongarage, "m25_2_ch1_06e_mansion_interior_b", 100);
			...
			//INTERIOR::_ENABLE_INTERIOR_PROP(MansionTop, "SET_LOFT_ARCADE_BLOCKER");
			//INTERIOR::_ENABLE_INTERIOR_PROP(MansionTop, "SET_LOFT_PODIUM_BLOCKER");
			INTERIOR::_ENABLE_INTERIOR_PROP(MansionTop, "SET_MICHAEL_CARD");
			...
			//INTERIOR::_ENABLE_INTERIOR_PROP(Mansionlow, "SET_MOD_BLOCKER");
			//INTERIOR::_ENABLE_INTERIOR_PROP(Mansiongarage, "SET_GAR_MOD_BLOCKER");
			//INTERIOR::_ENABLE_INTERIOR_PROP(MansionTop, "SET_AFTERPARTY");
			INTERIOR::_ENABLE_INTERIOR_PROP(MansionTop, "SET_AI_TABLETS_01");
			INTERIOR::_ENABLE_INTERIOR_PROP(MansionTop, "SET_AI_TABLETS_02");
			INTERIOR::_ENABLE_INTERIOR_PROP(MansionTop, "SET_AI_TABLETS_03");
			//INTERIOR::_ENABLE_INTERIOR_PROP(MansionTop, "SET_ARCADE_BLOCKER");
			//INTERIOR::_ENABLE_INTERIOR_PROP(MansionTop, "SET_ART_COASTAL");
			INTERIOR::_ENABLE_INTERIOR_PROP(MansionTop, "SET_ART_LOFT");
			//INTERIOR::_ENABLE_INTERIOR_PROP(MansionTop, "SET_ART_REGENCY");
			INTERIOR::_ENABLE_INTERIOR_PROP(MansionTop, "SET_BIRTHDAY");
			//INTERIOR::_ENABLE_INTERIOR_PROP(MansionTop, "SET_ELEV_CALI");
			//INTERIOR::_ENABLE_INTERIOR_PROP(MansionTop, "SET_ELEV_HOLLY");
			INTERIOR::_ENABLE_INTERIOR_PROP(MansionTop, "SET_ELEV_LOFT");
			//INTERIOR::_ENABLE_INTERIOR_PROP(MansionTop, "SET_HALLOWEEN");
			//INTERIOR::_ENABLE_INTERIOR_PROP(MansionTop, "SET_LOFT_ARCADE_BLOCKER");
			//INTERIOR::_ENABLE_INTERIOR_PROP(MansionTop, "SET_LOFT_PODIUM_BLOCKER");
			INTERIOR::_ENABLE_INTERIOR_PROP(MansionTop, "SET_LOFT_SHELVING_PLANTER");
			INTERIOR::_ENABLE_INTERIOR_PROP(MansionTop, "SET_LOFT_TROPHY_PLANTER");
			INTERIOR::_ENABLE_INTERIOR_PROP(MansionTop, "SET_LUNAR");
			//INTERIOR::_ENABLE_INTERIOR_PROP(MansionTop, "SET_MICHAEL_CARD");
			INTERIOR::_ENABLE_INTERIOR_PROP(MansionTop, "SET_MICHAEL_POSTER");
			INTERIOR::_ENABLE_INTERIOR_PROP(MansionTop, "SET_PET_CAT");
			//INTERIOR::_ENABLE_INTERIOR_PROP(MansionTop, "SET_PET_DOG");
			//INTERIOR::_ENABLE_INTERIOR_PROP(MansionTop, "SET_PODIUM_BLOCKER");
			//INTERIOR::_ENABLE_INTERIOR_PROP(MansionTop, "SET_REG_ARCADE_BLOCKER");
			//INTERIOR::_ENABLE_INTERIOR_PROP(MansionTop, "SET_REG_PODIUM_BLOCKER");
			INTERIOR::_ENABLE_INTERIOR_PROP(MansionTop, "SET_REG_SHELVING_PLANTER");
			INTERIOR::_ENABLE_INTERIOR_PROP(MansionTop, "SET_REG_TROPHY_PLANTER");
			INTERIOR::_ENABLE_INTERIOR_PROP(MansionTop, "SET_SHELVING_PLANTER");
			INTERIOR::_ENABLE_INTERIOR_PROP(MansionTop, "SET_STEP_COLLISION");
			//INTERIOR::_ENABLE_INTERIOR_PROP(MansionTop, "SET_STYLE_CALI");
			//INTERIOR::_ENABLE_INTERIOR_PROP(MansionTop, "SET_STYLE_CALI_TINT");
			//INTERIOR::_ENABLE_INTERIOR_PROP(MansionTop, "SET_STYLE_HOLLY");
			INTERIOR::_ENABLE_INTERIOR_PROP(MansionTop, "SET_STYLE_LOFT");
			INTERIOR::_ENABLE_INTERIOR_PROP(MansionTop, "SET_STYLE_LOFT_TINT");
			INTERIOR::_ENABLE_INTERIOR_PROP(MansionTop, "SET_STYLE_REG_TINT");
			INTERIOR::_ENABLE_INTERIOR_PROP(MansionTop, "SET_TROPHY_PLANTER");
			INTERIOR::_ENABLE_INTERIOR_PROP(MansionTop, "SET_TROPHY_SHELVES");
			INTERIOR::_ENABLE_INTERIOR_PROP(MansionTop, "SET_WALLPAPER_COASTAL");
			INTERIOR::_ENABLE_INTERIOR_PROP(MansionTop, "SET_WALLPAPER_DECO");
			INTERIOR::_ENABLE_INTERIOR_PROP(MansionTop, "SET_WALLPAPER_POPART");
			INTERIOR::_ENABLE_INTERIOR_PROP(MansionTop, "SET_WALLPAPER_RUSTIC");
			INTERIOR::_ENABLE_INTERIOR_PROP(MansionTop, "SET_WALLPAPER_SAFARI");
			INTERIOR::_ENABLE_INTERIOR_PROP(MansionTop, "SET_WALLPAPER_SUBTLE");
			//INTERIOR::_ENABLE_INTERIOR_PROP(MansionTop, "SET_XMAS");
	...
	if (featureHouseOnHill && ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()) && househill_init == true) {
		...
		AUDIO::SET_STATIC_EMITTER_ENABLED("se_dlc25-2_basement_armoury_loc_2", true);
		AUDIO::SET_STATIC_EMITTER_ENABLED("se_dlc25-2_basement_garage_loc_2", true);
		AUDIO::SET_STATIC_EMITTER_ENABLED("se_dlc25-2_basement_lobby_02_loc_2", true);
		AUDIO::SET_STATIC_EMITTER_ENABLED("se_dlc25-2_basement_lobby_03_loc_2", true);
		AUDIO::SET_STATIC_EMITTER_ENABLED("se_dlc25-2_basement_mod_garage_loc_2", true);
		AUDIO::SET_STATIC_EMITTER_ENABLED("se_dlc25-2_mansion_arcade_loc_2", true);
		AUDIO::SET_STATIC_EMITTER_ENABLED("se_dlc25-2_mansion_gallery_loc_2", true);
		AUDIO::SET_STATIC_EMITTER_ENABLED("se_dlc25-2_mansion_kitchen_loc_2", true);
		AUDIO::SET_STATIC_EMITTER_ENABLED("se_dlc25-2_mansion_lobby_loc_2", true);
		AUDIO::SET_STATIC_EMITTER_ENABLED("se_dlc25-2_mansion_trophy_room_loc_2", true);
		AUDIO::SET_STATIC_EMITTER_ENABLED("se_dlc25-2_mansion_office_loc_2", true);
		AUDIO::SET_STATIC_EMITTER_ENABLED("se_dlc25-2_mansion_cigar_room_loc_2", true);
		AUDIO::SET_STATIC_EMITTER_ENABLED("se_dlc25-2_mansion_guest_bedroom_loc_2", true);
		AUDIO::SET_STATIC_EMITTER_ENABLED("se_dlc25-2_mansion_master_bedroom_loc_2", true);
		AUDIO::SET_STATIC_EMITTER_ENABLED("se_dlc25-2_basement_garage_top_loc_2", true);
		AUDIO::SET_STATIC_EMITTER_ENABLED("dlc25-2_mansion_exterior_central_loc_2", true);
		AUDIO::SET_STATIC_EMITTER_ENABLED("se_dlc25-2_mansion_exterior_pool_bar_loc_2", true);
		AUDIO::SET_STATIC_EMITTER_ENABLED("se_dlc25-2_mansion_exterior_terrace_loc_2", true);
		AUDIO::SET_STATIC_EMITTER_ENABLED("se_dlc25-2_basement_club_01_loc_2", true);
		AUDIO::SET_STATIC_EMITTER_ENABLED("se_dlc25-2_basement_club_02_loc_2", true);
	}
